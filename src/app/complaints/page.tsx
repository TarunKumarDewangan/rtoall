...
// Mirrors the VARCHAR limits in the complaints table. Pasted data that
...
const FIELD_MAX_LENGTHS: Record<string, number> = {
  token_no: 50, officer_level: 20, mobile_no: 20, district: 100,
  ...
  async function importRows(parsed: ParsedComplaintRow[]) {
    ...
    if (invalid.length > 0) {
      showMsg('error',
        ...
        `अगर आप किसी एक शिकायत का पूरा विवरण डाल रहे हैं तो कृपया "+ Add Complaint" इस्तेमाल करें — Bulk Import सिर्फ Excel की कई पंक्तियों के लिए है।`
      )
      return
    }
